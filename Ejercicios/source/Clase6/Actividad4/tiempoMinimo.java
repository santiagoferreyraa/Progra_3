...
public class tiempoMinimo {
    ...
    static class Grafo {
        ...
        void agregarRuta(int origen, int destino, int tiempo) {
            arr.get(origen).add(new Ruta(destino, tiempo));
            arr.get(destino).add(new Ruta(origen, tiempo));
        }
